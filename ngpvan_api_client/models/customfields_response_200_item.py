...
from ..models.customfields_response_200_item_available_values_item import CustomfieldsResponse200ItemAvailableValuesItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="CustomfieldsResponse200Item")


@attr.s(auto_attribs=True)
class CustomfieldsResponse200Item:
    """
    Attributes:
        ...
        available_values (Union[Unset, List[CustomfieldsResponse200ItemAvailableValuesItem]]):
    """
    ...
    available_values: Union[Unset, List[CustomfieldsResponse200ItemAvailableValuesItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for available_values_item_data in _available_values or []:
            available_values_item = CustomfieldsResponse200ItemAvailableValuesItem.from_dict(available_values_item_data)

            available_values.append(available_values_item)

        customfields_response_200_item = cls(
        ...
        customfields_response_200_item.additional_properties = d
        return customfields_response_200_item
