...
T = TypeVar("T", bound="ActivistcodesactivistcodeidResponse200")


@attr.s(auto_attribs=True)
class ActivistcodesactivistcodeidResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        activistcodesactivistcodeid_response_200 = cls(
        ...
        activistcodesactivistcodeid_response_200.additional_properties = d
        return activistcodesactivistcodeid_response_200
