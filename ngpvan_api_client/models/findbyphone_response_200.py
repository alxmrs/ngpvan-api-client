...
T = TypeVar("T", bound="FindbyphoneResponse200")


@attr.s(auto_attribs=True)
class FindbyphoneResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        findbyphone_response_200.additional_properties = d
        return findbyphone_response_200
