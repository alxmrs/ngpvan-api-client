...
from ..models.codes_batch_json_body_codes_item_supported_entities_item import (
    CodesBatchJsonBodyCodesItemSupportedEntitiesItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CodesBatchJsonBodyCodesItem")


@attr.s(auto_attribs=True)
class CodesBatchJsonBodyCodesItem:
    """
    Attributes:
        ...
        supported_entities (Union[Unset, List[CodesBatchJsonBodyCodesItemSupportedEntitiesItem]]):
    ...
    supported_entities: Union[Unset, List[CodesBatchJsonBodyCodesItemSupportedEntitiesItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for supported_entities_item_data in _supported_entities or []:
            supported_entities_item = CodesBatchJsonBodyCodesItemSupportedEntitiesItem.from_dict(
        ...
        codes_batch_json_body_codes_item = cls(
        ...
        codes_batch_json_body_codes_item.additional_properties = d
        return codes_batch_json_body_codes_item
