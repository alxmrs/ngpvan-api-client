...
T = TypeVar("T", bound="LocationsfindorcreateJsonBodyAddress")


@attr.s(auto_attribs=True)
class LocationsfindorcreateJsonBodyAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        locationsfindorcreate_json_body_address = cls(
        ...
        locationsfindorcreate_json_body_address.additional_properties = d
        return locationsfindorcreate_json_body_address
