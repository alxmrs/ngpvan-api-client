...
T = TypeVar("T", bound="ChangedentityexportjobsResponse201FilesItem")


@attr.s(auto_attribs=True)
class ChangedentityexportjobsResponse201FilesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        changedentityexportjobs_response_201_files_item = cls(
            download_url=download_url,
            date_expired=date_expired,
        )

        changedentityexportjobs_response_201_files_item.additional_properties = d
        return changedentityexportjobs_response_201_files_item
