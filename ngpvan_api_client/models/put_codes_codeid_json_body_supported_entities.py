...
T = TypeVar("T", bound="PutCodesCodeidJsonBodySupportedEntities")


@attr.s(auto_attribs=True)
class PutCodesCodeidJsonBodySupportedEntities:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_codes_codeid_json_body_supported_entities = cls(
            name=name,
            is_searchable=is_searchable,
            is_applicable=is_applicable,
        )

        put_codes_codeid_json_body_supported_entities.additional_properties = d
        return put_codes_codeid_json_body_supported_entities
