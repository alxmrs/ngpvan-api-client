...
T = TypeVar("T", bound="PeoplefindorcreateResponse200")


@attr.s(auto_attribs=True)
class PeoplefindorcreateResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplefindorcreate_response_200 = cls(
            van_id=van_id,
        ...
        peoplefindorcreate_response_200.additional_properties = d
        return peoplefindorcreate_response_200
