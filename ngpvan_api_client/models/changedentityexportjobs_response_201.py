...
from ..models.changedentityexportjobs_response_201_files_item import ChangedentityexportjobsResponse201FilesItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ChangedentityexportjobsResponse201")


@attr.s(auto_attribs=True)
class ChangedentityexportjobsResponse201:
    """
    Attributes:
        ...
        files (Union[Unset, List[ChangedentityexportjobsResponse201FilesItem]]):
        ...
        exclude_changes_from_self (Union[Unset, str]):  Example: true.
    """
    ...
    files: Union[Unset, List[ChangedentityexportjobsResponse201FilesItem]] = UNSET
    message: Union[Unset, str] = UNSET
    code: Union[Unset, Any] = UNSET
    exported_record_count: Union[Unset, int] = 0
    exclude_changes_from_self: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        exclude_changes_from_self = self.exclude_changes_from_self
        ...
        if exclude_changes_from_self is not UNSET:
            field_dict["excludeChangesFromSelf"] = exclude_changes_from_self
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for files_item_data in _files or []:
            files_item = ChangedentityexportjobsResponse201FilesItem.from_dict(files_item_data)
        ...
        exclude_changes_from_self = d.pop("excludeChangesFromSelf", UNSET)

        changedentityexportjobs_response_201 = cls(
            ...
            exclude_changes_from_self=exclude_changes_from_self,
        )

        changedentityexportjobs_response_201.additional_properties = d
        return changedentityexportjobs_response_201
