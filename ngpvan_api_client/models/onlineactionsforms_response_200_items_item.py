...
from ..models.onlineactionsforms_response_200_items_item_confirmation_email_data import (
    OnlineactionsformsResponse200ItemsItemConfirmationEmailData,
)
from ..models.onlineactionsforms_response_200_items_item_designation import (
    OnlineactionsformsResponse200ItemsItemDesignation,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="OnlineactionsformsResponse200ItemsItem")


@attr.s(auto_attribs=True)
class OnlineactionsformsResponse200ItemsItem:
    """
    Attributes:
        ...
        designation (Union[Unset, OnlineactionsformsResponse200ItemsItemDesignation]):
        confirmation_email_data (Union[Unset, OnlineactionsformsResponse200ItemsItemConfirmationEmailData]):
    ...
    designation: Union[Unset, OnlineactionsformsResponse200ItemsItemDesignation] = UNSET
    confirmation_email_data: Union[Unset, OnlineactionsformsResponse200ItemsItemConfirmationEmailData] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_designation, Unset):
            ...
            designation = OnlineactionsformsResponse200ItemsItemDesignation.from_dict(_designation)
        ...
        if isinstance(_confirmation_email_data, Unset):
            ...
            confirmation_email_data = OnlineactionsformsResponse200ItemsItemConfirmationEmailData.from_dict(
        ...
        onlineactionsforms_response_200_items_item = cls(
        ...
        onlineactionsforms_response_200_items_item.additional_properties = d
        return onlineactionsforms_response_200_items_item
