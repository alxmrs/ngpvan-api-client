...
T = TypeVar("T", bound="Usersuseriddistrictfieldvalues1Response200")


@attr.s(auto_attribs=True)
class Usersuseriddistrictfieldvalues1Response200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        usersuseriddistrictfieldvalues_1_response_200 = cls(
            district_field_values=district_field_values,
        )

        usersuseriddistrictfieldvalues_1_response_200.additional_properties = d
        return usersuseriddistrictfieldvalues_1_response_200
