...
T = TypeVar("T", bound="BulkimportmappingtypesResponse200ItemsItemFieldsItem")


@attr.s(auto_attribs=True)
class BulkimportmappingtypesResponse200ItemsItemFieldsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bulkimportmappingtypes_response_200_items_item_fields_item = cls(
            name=name,
        ...
        bulkimportmappingtypes_response_200_items_item_fields_item.additional_properties = d
        return bulkimportmappingtypes_response_200_items_item_fields_item
