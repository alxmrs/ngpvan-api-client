...
from ..models.peoplevanidcanvassresponses_json_body_responses_item_action import (
    PeoplevanidcanvassresponsesJsonBodyResponsesItemAction,
)
from ..models.peoplevanidcanvassresponses_json_body_responses_item_type import (
    PeoplevanidcanvassresponsesJsonBodyResponsesItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PeoplevanidcanvassresponsesJsonBodyResponsesItem")


@attr.s(auto_attribs=True)
class PeoplevanidcanvassresponsesJsonBodyResponsesItem:
    """
    Attributes:
        type (PeoplevanidcanvassresponsesJsonBodyResponsesItemType): The `type` of this response dictates the validation
            requirements of other properties. One of `ActivistCode`, `SurveyResponse`, or `VolunteerActivity`
        action (Union[Unset, PeoplevanidcanvassresponsesJsonBodyResponsesItemAction]): Indicates whether to apply or
            remove this response from a person (valid for `ActivistCode` and `VolunteerActivity` only) Default:
            PeoplevanidcanvassresponsesJsonBodyResponsesItemAction.APPLY.
    ...
    type: PeoplevanidcanvassresponsesJsonBodyResponsesItemType
    action: Union[
        Unset, PeoplevanidcanvassresponsesJsonBodyResponsesItemAction
    ] = PeoplevanidcanvassresponsesJsonBodyResponsesItemAction.APPLY
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        type = PeoplevanidcanvassresponsesJsonBodyResponsesItemType(d.pop("type"))

        _action = d.pop("action", UNSET)
        action: Union[Unset, PeoplevanidcanvassresponsesJsonBodyResponsesItemAction]
        if isinstance(_action, Unset):
            action = UNSET
        else:
            action = PeoplevanidcanvassresponsesJsonBodyResponsesItemAction(_action)
        ...
        peoplevanidcanvassresponses_json_body_responses_item = cls(
            type=type,
            action=action,
        ...
        peoplevanidcanvassresponses_json_body_responses_item.additional_properties = d
        return peoplevanidcanvassresponses_json_body_responses_item
