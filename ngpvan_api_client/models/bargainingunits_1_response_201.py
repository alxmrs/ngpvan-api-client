...
T = TypeVar("T", bound="Bargainingunits1Response201")


@attr.s(auto_attribs=True)
class Bargainingunits1Response201:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bargainingunits_1_response_201 = cls(
            bargaining_unit_id=bargaining_unit_id,
            name=name,
            short_name=short_name,
        )

        bargainingunits_1_response_201.additional_properties = d
        return bargainingunits_1_response_201
