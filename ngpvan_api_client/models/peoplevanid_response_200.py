...
T = TypeVar("T", bound="PeoplevanidResponse200")


@attr.s(auto_attribs=True)
class PeoplevanidResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplevanid_response_200.additional_properties = d
        return peoplevanid_response_200
