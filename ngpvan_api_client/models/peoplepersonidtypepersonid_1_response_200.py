...
T = TypeVar("T", bound="Peoplepersonidtypepersonid1Response200")


@attr.s(auto_attribs=True)
class Peoplepersonidtypepersonid1Response200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplepersonidtypepersonid_1_response_200 = cls(
            van_id=van_id,
        ...
        peoplepersonidtypepersonid_1_response_200.additional_properties = d
        return peoplepersonidtypepersonid_1_response_200
