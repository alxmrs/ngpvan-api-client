...
T = TypeVar("T", bound="PeoplefindResponse200")


@attr.s(auto_attribs=True)
class PeoplefindResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplefind_response_200.additional_properties = d
        return peoplefind_response_200
