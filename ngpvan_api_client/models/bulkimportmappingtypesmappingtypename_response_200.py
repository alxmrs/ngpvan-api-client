...
from ..models.bulkimportmappingtypesmappingtypename_response_200_fields_item import (
    BulkimportmappingtypesmappingtypenameResponse200FieldsItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkimportmappingtypesmappingtypenameResponse200")


@attr.s(auto_attribs=True)
class BulkimportmappingtypesmappingtypenameResponse200:
    """
    Attributes:
        ...
        fields (Union[Unset, List[BulkimportmappingtypesmappingtypenameResponse200FieldsItem]]):
    """
    ...
    fields: Union[Unset, List[BulkimportmappingtypesmappingtypenameResponse200FieldsItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for fields_item_data in _fields or []:
            fields_item = BulkimportmappingtypesmappingtypenameResponse200FieldsItem.from_dict(fields_item_data)

            fields.append(fields_item)

        bulkimportmappingtypesmappingtypename_response_200 = cls(
            name=name,
        ...
        bulkimportmappingtypesmappingtypename_response_200.additional_properties = d
        return bulkimportmappingtypesmappingtypename_response_200
