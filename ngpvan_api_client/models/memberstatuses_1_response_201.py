...
T = TypeVar("T", bound="Memberstatuses1Response201")


@attr.s(auto_attribs=True)
class Memberstatuses1Response201:
    """
    Attributes:
        member_status_id (Union[Unset, int]):  Example: 321.
        name (Union[Unset, str]):  Example: Non-Member.
        is_member (Union[Unset, bool]):  Default: True.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        memberstatuses_1_response_201 = cls(
            member_status_id=member_status_id,
            name=name,
            is_member=is_member,
        )

        memberstatuses_1_response_201.additional_properties = d
        return memberstatuses_1_response_201
