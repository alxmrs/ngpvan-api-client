...
T = TypeVar("T", bound="PeoplepersonidtypepersonidnotesJsonBodyCategory")


@attr.s(auto_attribs=True)
class PeoplepersonidtypepersonidnotesJsonBodyCategory:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplepersonidtypepersonidnotes_json_body_category = cls(
            note_category_id=note_category_id,
        )

        peoplepersonidtypepersonidnotes_json_body_category.additional_properties = d
        return peoplepersonidtypepersonidnotes_json_body_category
