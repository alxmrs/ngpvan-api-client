...
T = TypeVar("T", bound="ShifttypesshifttypeidResponse200")


@attr.s(auto_attribs=True)
class ShifttypesshifttypeidResponse200:
    """
    Attributes:
        shift_type_id (Union[Unset, int]):  Example: 12.
        name (Union[Unset, str]):  Example: Day.
        default_start_time (Union[Unset, str]):  Example: 1900-01-01T06:00Z.
        default_end_time (Union[Unset, str]):  Example: 1900-01-01T18:00Z.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        shifttypesshifttypeid_response_200 = cls(
        ...
        shifttypesshifttypeid_response_200.additional_properties = d
        return shifttypesshifttypeid_response_200
