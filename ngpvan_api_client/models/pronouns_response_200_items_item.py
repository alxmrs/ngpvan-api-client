...
T = TypeVar("T", bound="PronounsResponse200ItemsItem")


@attr.s(auto_attribs=True)
class PronounsResponse200ItemsItem:
    """
    Attributes:
        pronoun_id (Union[Unset, int]):  Example: 6.
        pronoun_name (Union[Unset, str]):  Example: E/Em/Eirs.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pronouns_response_200_items_item = cls(
            pronoun_id=pronoun_id,
            pronoun_name=pronoun_name,
        )

        pronouns_response_200_items_item.additional_properties = d
        return pronouns_response_200_items_item
