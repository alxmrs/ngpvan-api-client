...
T = TypeVar("T", bound="Signupseventsignupid1Response200Shift")


@attr.s(auto_attribs=True)
class Signupseventsignupid1Response200Shift:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        signupseventsignupid_1_response_200_shift = cls(
            event_shift_id=event_shift_id,
            name=name,
        )

        signupseventsignupid_1_response_200_shift.additional_properties = d
        return signupseventsignupid_1_response_200_shift
