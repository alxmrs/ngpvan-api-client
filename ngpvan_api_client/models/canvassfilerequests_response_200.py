...
T = TypeVar("T", bound="CanvassfilerequestsResponse200")


@attr.s(auto_attribs=True)
class CanvassfilerequestsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        canvassfilerequests_response_200 = cls(
        ...
        canvassfilerequests_response_200.additional_properties = d
        return canvassfilerequests_response_200
