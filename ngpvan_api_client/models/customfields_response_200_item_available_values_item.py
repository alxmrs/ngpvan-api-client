...
T = TypeVar("T", bound="CustomfieldsResponse200ItemAvailableValuesItem")


@attr.s(auto_attribs=True)
class CustomfieldsResponse200ItemAvailableValuesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customfields_response_200_item_available_values_item = cls(
            id=id,
            name=name,
            parent_value_id=parent_value_id,
        )

        customfields_response_200_item_available_values_item.additional_properties = d
        return customfields_response_200_item_available_values_item
