...
T = TypeVar("T", bound="UsersuseriddistrictfieldvaluesResponse200")


@attr.s(auto_attribs=True)
class UsersuseriddistrictfieldvaluesResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        usersuseriddistrictfieldvalues_response_200 = cls(
            district_field_values=district_field_values,
        )

        usersuseriddistrictfieldvalues_response_200.additional_properties = d
        return usersuseriddistrictfieldvalues_response_200
