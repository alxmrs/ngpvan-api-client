...
T = TypeVar("T", bound="EmployersemployeridworksitesResponse201Address")


@attr.s(auto_attribs=True)
class EmployersemployeridworksitesResponse201Address:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 77 Salem Street.
        unit_no (Union[Unset, str]):  Example: Room H104.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        employersemployeridworksites_response_201_address = cls(
        ...
        employersemployeridworksites_response_201_address.additional_properties = d
        return employersemployeridworksites_response_201_address
