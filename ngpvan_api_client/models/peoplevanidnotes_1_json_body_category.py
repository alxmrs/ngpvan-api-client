...
T = TypeVar("T", bound="Peoplevanidnotes1JsonBodyCategory")


@attr.s(auto_attribs=True)
class Peoplevanidnotes1JsonBodyCategory:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplevanidnotes_1_json_body_category = cls(
            note_category_id=note_category_id,
        )

        peoplevanidnotes_1_json_body_category.additional_properties = d
        return peoplevanidnotes_1_json_body_category
