...
T = TypeVar("T", bound="Signupseventsignupid1Response200Person")


@attr.s(auto_attribs=True)
class Signupseventsignupid1Response200Person:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        signupseventsignupid_1_response_200_person = cls(
            van_id=van_id,
        ...
        signupseventsignupid_1_response_200_person.additional_properties = d
        return signupseventsignupid_1_response_200_person
