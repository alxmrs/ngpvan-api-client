...
T = TypeVar("T", bound="Scores1Response200ItemsItem")


@attr.s(auto_attribs=True)
class Scores1Response200ItemsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        scores_1_response_200_items_item = cls(
            score_id=score_id,
            name=name,
        ...
        scores_1_response_200_items_item.additional_properties = d
        return scores_1_response_200_items_item
