...
T = TypeVar("T", bound="PutCodesJsonBodyCodesItemSupportedEntitiesItem")


@attr.s(auto_attribs=True)
class PutCodesJsonBodyCodesItemSupportedEntitiesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_codes_json_body_codes_item_supported_entities_item = cls(
            name=name,
            is_searchable=is_searchable,
            is_applicable=is_applicable,
        )

        put_codes_json_body_codes_item_supported_entities_item.additional_properties = d
        return put_codes_json_body_codes_item_supported_entities_item
