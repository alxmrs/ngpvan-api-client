...
T = TypeVar("T", bound="Peoplevanidnotes1JsonBodyContactHistory")


@attr.s(auto_attribs=True)
class Peoplevanidnotes1JsonBodyContactHistory:
    """Optional; if specified, creates a Contact History record with the note, and must be a valid `Contact History` object
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplevanidnotes_1_json_body_contact_history = cls(
        ...
        peoplevanidnotes_1_json_body_contact_history.additional_properties = d
        return peoplevanidnotes_1_json_body_contact_history
