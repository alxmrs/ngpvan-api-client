...
T = TypeVar("T", bound="Usersuseriddistrictfieldvalues1JsonBody")


@attr.s(auto_attribs=True)
class Usersuseriddistrictfieldvalues1JsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        usersuseriddistrictfieldvalues_1_json_body = cls(
            district_field_values=district_field_values,
        )

        usersuseriddistrictfieldvalues_1_json_body.additional_properties = d
        return usersuseriddistrictfieldvalues_1_json_body
