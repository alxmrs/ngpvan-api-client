...
T = TypeVar("T", bound="PeoplefindJsonBody")


@attr.s(auto_attribs=True)
class PeoplefindJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplefind_json_body.additional_properties = d
        return peoplefind_json_body
