...
from ..models.peoplepersonidtypepersonidcanvassresponses_json_body_canvass_context_phone import (
    PeoplepersonidtypepersonidcanvassresponsesJsonBodyCanvassContextPhone,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PeoplepersonidtypepersonidcanvassresponsesJsonBodyCanvassContext")


@attr.s(auto_attribs=True)
class PeoplepersonidtypepersonidcanvassresponsesJsonBodyCanvassContext:
    ...
    Attributes:
        ...
        phone (Union[Unset, PeoplepersonidtypepersonidcanvassresponsesJsonBodyCanvassContextPhone]): Optional; describes
            the context of the phone number used to contact the person
    ...
    phone: Union[Unset, PeoplepersonidtypepersonidcanvassresponsesJsonBodyCanvassContextPhone] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        phone: Union[Unset, PeoplepersonidtypepersonidcanvassresponsesJsonBodyCanvassContextPhone]
        if isinstance(_phone, Unset):
            phone = UNSET
        else:
            phone = PeoplepersonidtypepersonidcanvassresponsesJsonBodyCanvassContextPhone.from_dict(_phone)

        campaign_id = d.pop("campaignId", UNSET)

        content_id = d.pop("contentId", UNSET)

        peoplepersonidtypepersonidcanvassresponses_json_body_canvass_context = cls(
        ...
        peoplepersonidtypepersonidcanvassresponses_json_body_canvass_context.additional_properties = d
        return peoplepersonidtypepersonidcanvassresponses_json_body_canvass_context
