...
T = TypeVar("T", bound="PeoplepersonidtypepersonidResponse200")


@attr.s(auto_attribs=True)
class PeoplepersonidtypepersonidResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplepersonidtypepersonid_response_200 = cls(
            van_id=van_id,
        ...
        peoplepersonidtypepersonid_response_200.additional_properties = d
        return peoplepersonidtypepersonid_response_200
