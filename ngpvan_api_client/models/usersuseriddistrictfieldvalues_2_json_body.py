...
T = TypeVar("T", bound="Usersuseriddistrictfieldvalues2JsonBody")


@attr.s(auto_attribs=True)
class Usersuseriddistrictfieldvalues2JsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        usersuseriddistrictfieldvalues_2_json_body = cls(
            district_field_values=district_field_values,
        )

        usersuseriddistrictfieldvalues_2_json_body.additional_properties = d
        return usersuseriddistrictfieldvalues_2_json_body
