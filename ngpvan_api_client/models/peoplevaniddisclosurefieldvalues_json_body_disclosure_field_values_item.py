...
T = TypeVar("T", bound="PeoplevaniddisclosurefieldvaluesJsonBodyDisclosureFieldValuesItem")


@attr.s(auto_attribs=True)
class PeoplevaniddisclosurefieldvaluesJsonBodyDisclosureFieldValuesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        peoplevaniddisclosurefieldvalues_json_body_disclosure_field_values_item = cls(
            disclosure_field_id=disclosure_field_id,
            disclosure_field_value=disclosure_field_value,
            designation_id=designation_id,
        )

        peoplevaniddisclosurefieldvalues_json_body_disclosure_field_values_item.additional_properties = d
        return peoplevaniddisclosurefieldvalues_json_body_disclosure_field_values_item
