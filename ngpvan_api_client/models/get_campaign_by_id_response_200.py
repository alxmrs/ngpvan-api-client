...
from ..models.get_campaign_by_id_response_200_campaign_type import GetCampaignByIdResponse200CampaignType
from ..models.get_campaign_by_id_response_200_contents_item import GetCampaignByIdResponse200ContentsItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCampaignByIdResponse200")


@attr.s(auto_attribs=True)
class GetCampaignByIdResponse200:
    """
    Attributes:
        campaign_id (Union[Unset, int]):  Example: 7919.
        name (Union[Unset, str]):  Example: Increase the Minimum Wage.
        campaign_type (Union[Unset, GetCampaignByIdResponse200CampaignType]):
        campaign_display_name (Union[Unset, str]):  Example: Advocacy: Increase the Minimum Wage.
        status (Union[Unset, str]):  Example: Active.
        contents (Union[Unset, List[GetCampaignByIdResponse200ContentsItem]]):
    """

    campaign_id: Union[Unset, int] = 0
    name: Union[Unset, str] = UNSET
    campaign_type: Union[Unset, GetCampaignByIdResponse200CampaignType] = UNSET
    campaign_display_name: Union[Unset, str] = UNSET
    status: Union[Unset, str] = UNSET
    contents: Union[Unset, List[GetCampaignByIdResponse200ContentsItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_campaign_type, Unset):
            ...
            campaign_type = GetCampaignByIdResponse200CampaignType.from_dict(_campaign_type)
        ...
        for contents_item_data in _contents or []:
            contents_item = GetCampaignByIdResponse200ContentsItem.from_dict(contents_item_data)

            contents.append(contents_item)

        get_campaign_by_id_response_200 = cls(
        ...
        get_campaign_by_id_response_200.additional_properties = d
        return get_campaign_by_id_response_200
