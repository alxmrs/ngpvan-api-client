...
T = TypeVar("T", bound="OnlineactionsformsformtrackingidResponse200ConfirmationEmailData")


@attr.s(auto_attribs=True)
class OnlineactionsformsformtrackingidResponse200ConfirmationEmailData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        onlineactionsformsformtrackingid_response_200_confirmation_email_data = cls(
        ...
        onlineactionsformsformtrackingid_response_200_confirmation_email_data.additional_properties = d
        return onlineactionsformsformtrackingid_response_200_confirmation_email_data
