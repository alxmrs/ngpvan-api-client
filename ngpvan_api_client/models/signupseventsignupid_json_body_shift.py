...
T = TypeVar("T", bound="SignupseventsignupidJsonBodyShift")


@attr.s(auto_attribs=True)
class SignupseventsignupidJsonBodyShift:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        signupseventsignupid_json_body_shift = cls(
            event_shift_id=event_shift_id,
        )

        signupseventsignupid_json_body_shift.additional_properties = d
        return signupseventsignupid_json_body_shift
