...
T = TypeVar("T", bound="CodesBatchJsonBodyCodesItemSupportedEntitiesItem")


@attr.s(auto_attribs=True)
class CodesBatchJsonBodyCodesItemSupportedEntitiesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codes_batch_json_body_codes_item_supported_entities_item = cls(
            name=name,
            is_searchable=is_searchable,
            is_applicable=is_applicable,
        )

        codes_batch_json_body_codes_item_supported_entities_item.additional_properties = d
        return codes_batch_json_body_codes_item_supported_entities_item
